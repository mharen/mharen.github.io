...
![asp2-2.png]({{ "/assets/2012/asp2-2.png" | relative_url }})
...
![expired-2.png]({{ "/assets/2012/expired-2.png" | relative_url }})
...
![add-2.png]({{ "/assets/2012/add-2.png" | relative_url }})

Neat! Let’s do that.

![uber secret-2.png]({{ "/assets/2012/uber secret-2.png" | relative_url }})

Cool, there is (at least before I sanitized it for this blog) a longish, random password I can enter on my phone.  

![2012-11-02 21.37.27.png]({{ "/assets/2012/2012-11-02 21.37.27.png" | relative_url }})
