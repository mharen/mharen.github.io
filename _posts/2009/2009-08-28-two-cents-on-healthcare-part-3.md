...
**Finally, I want to refocus my position on this issue: **     * Everyone should have health care coverage    * Coverage should be similar to what I have (I’m middle class, I pay small $15-20 co-pays for office visits, and all the important stuff is covered)    * Coverage should be mandatory    * Coverage need not be free (but it must be affordable)    * These steps are necessary for the fiscal stability of our nation as the [status quo is unsustainable](http://www.youtube.com/watch?v=Jng4TnKqy6A) (thanks for the video, Steve!) 
