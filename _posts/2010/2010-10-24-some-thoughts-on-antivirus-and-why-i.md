...
[{% imagesize /assets/2010/network-6.png:img alt="Viruses so far have been really disappointing on the 'disable the internet' front, and time is running out. When Linux/Mac win in a decade or so the game will be over." %}](https://xkcd.com/350/)
