...
![image[23].png](/assets/2010/image[23].png)  <h4>Masthead Flowers</h4>
...
![image[28].png](/assets/2010/image[28].png)

Let’s override that CSS, and the second flower as well:

![image[45].png](/assets/2010/image[45].png)    

Pow:

![image[50].png](/assets/2010/image[50].png)  <h4>Colors</h4>

I’ll tweak the header color (purple) and image border color (pink) next.

![image[54].png](/assets/2010/image[54].png)    

Bam:

![image[59].png](/assets/2010/image[59].png)  <h4>Navigation Bar</h4>
...
![image[68].png](/assets/2010/image[68].png)

Result:

![image[64].png](/assets/2010/image[64].png)    <h4>Masthead</h4>

The final piece is the actual site logo—the baby face. Sarah might put her own together, but until then I’ll use this:

![image[73].png](/assets/2010/image[73].png)
