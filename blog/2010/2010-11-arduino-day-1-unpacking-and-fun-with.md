...
Time for a quick program. I downloaded the <a href="http://arduino.cc/en/Main/Software">Arduino software</a>, unzipped it, and fired it up (no install). 
...
Here are dozens of neat examples to start with. I chose Basics &gt; Fade to play around with the LEDs I had. The sample code just fades an LED on and off forever. After wiring up the board according to the <a href="http://arduino.cc/en/Tutorial/Fade">incredible directions</a> on the site, it worked! Amazing.
...
Circuit (built with the amazing <a href="http://fritzing.org/">Fritzing</a>):

![day%20one%20-%20bb%5B6%5D.png](day%20one%20-%20bb%5B6%5D.png)

Schematic (automatically built from the above image with the amazing <a href="http://fritzing.org/">Fritzing</a>):
